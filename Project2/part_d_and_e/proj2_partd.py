...
"""
def train_network(
    inputs, layers, layers_prev, activation_funcs, target, threshold, learning_rate=0.1, gamma = 0.0001, epochs=3000
):
...
#
"""
#den fra ukesoppgavene
layer_output_sizes = [8,1] #den siste må være 1 og siste activation skal være sigmoid
activation_funcs = [sivNN.sigmoid,sivNN.sigmoid]
activation_ders = [sivNN.sigmoid_der, sivNN.sigmoid_der]
"""

#ett skjult lag sigmoid
layer_output_sizes = [5,1] #den siste må være 1 og siste activation skal være sigmoid
activation_funcs = [sivNN.sigmoid,sivNN.sigmoid]
activation_ders = [sivNN.sigmoid_der, sivNN.sigmoid_der]

"""
#ett skjult lag, ReLU
layer_output_sizes = [10,1] #den siste må være 1 og siste activation skal være sigmoid
activation_funcs = [sivNN.ReLU,sivNN.sigmoid]
activation_ders = [sivNN.ReLU_der, sivNN.sigmoid_der]
"""
"""
#2 skjulte lag
layer_output_sizes = [30,30,1] #den siste må være 1 og siste activation skal være sigmoid
activation_funcs = [sivNN.sigmoid,sivNN.sigmoid,sivNN.sigmoid]
activation_ders = [sivNN.sigmoid_der,sivNN.sigmoid_der, sivNN.sigmoid_der]
"""
"""
#3skulte lag
layer_output_sizes = [30,30,30,1] #den siste må være 1 og siste activation skal være sigmoid
activation_funcs = [sivNN.sigmoid,sivNN.sigmoid,sivNN.sigmoid,sivNN.sigmoid]
activation_ders = [sivNN.sigmoid_der,sivNN.sigmoid_der,sivNN.sigmoid_der, sivNN.sigmoid_der]
"""
"""
#5 skjulte lag
layer_output_sizes = [30,30,30,30,30,1] #den siste må være 1 og siste activation skal være sigmoid
activation_funcs = [sivNN.sigmoid,sivNN.sigmoid,sivNN.sigmoid,sivNN.sigmoid,sivNN.sigmoid,sivNN.sigmoid]
activation_ders = [sivNN.sigmoid_der,sivNN.sigmoid_der,sivNN.sigmoid_der,sivNN.sigmoid_der,sivNN.sigmoid_der, sivNN.sigmoid_der]
"""
...
#trener nettverket
train_network(x_train, layers, layers_prev, activation_funcs, target_train, threshold, learning_rate = 1.0, gamma = 0.000001)
