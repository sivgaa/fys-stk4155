...
def train_network(
    inputs, layers, layers_prev, activation_funcs, target, threshold, learning_rate=0.1, gamma = 0.0001, epochs=1000
):
...
"""
#ett lag 30 noder
layer_output_sizes = [30,1] #den siste må være 1 og siste activation skal være sigmoid
activation_funcs = [sivNN.sigmoid,sivNN.sigmoid]
activation_ders = [sivNN.sigmoid_der, sivNN.sigmoid_der]
